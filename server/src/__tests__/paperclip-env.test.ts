...
describe("buildPaperclipEnv", () => {
  it("prefers a dedicated agent API URL over runtime and public URLs", () => {
    process.env.PAPERCLIP_AGENT_API_URL = "http://paperclip.internal:3100";
    process.env.PAPERCLIP_RUNTIME_API_URL = "http://203.0.113.42:3102";
    process.env.PAPERCLIP_API_URL = "https://paperclip.example.test";

    const env = buildPaperclipEnv({ id: "agent-1", companyId: "company-1" });

    expect(env.PAPERCLIP_API_URL).toBe("http://paperclip.internal:3100");
  });

  it("prefers an explicit PAPERCLIP_RUNTIME_API_URL over PAPERCLIP_API_URL", () => {
  ...
  it("ignores a blank agent API URL override", () => {
    process.env.PAPERCLIP_AGENT_API_URL = "   ";
    process.env.PAPERCLIP_RUNTIME_API_URL = "http://127.0.0.1:3102";
    process.env.PAPERCLIP_API_URL = "https://paperclip.example.test";
